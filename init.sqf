...
if (!isDedicated) then
{
	[] spawn
	{
		...
		{
			9999 cutText ["Welcome to UFA A3Wasteland Sahrani! You'll be loaded in just a sec...", "BLACK", 0.01];
...
if (isServer) then
{
	...
	diag_log "WASTELAND SERVER - Loading Server";
...
if (hasInterface || isServer) then
{
	...
	[] execVM "addons\scripts\Server_WelcomeCredits.sqf"; //Dayz Like intro
	[] execVM "Vcom\VcomInit.sqf";	//VCOM AI
};
...
null = [] execVM "addons\scripts\IntLight.sqf";

//StatusBar by CREAMPIE
